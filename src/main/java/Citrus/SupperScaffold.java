...
public class SupperScaffold {
    ...
    String scafold_fragment_subType_ID;
//    int order;
    int start_in_superscaffold;
    int size_in_superscaffold;
...
//        order = Integer.parseInt(strarray[1]);
    ...
    public SupperScaffold split(long genome_split_pos, int display_split_pos, int strand) {
        ...
        String new_scafold_fragment_subType_ID = Citrus.SS_ID_increase_1(scafold_fragment_subType_ID);
