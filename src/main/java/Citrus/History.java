...
public class History {
    int type; //0:transpose (fragment) 10:transpose (chrom) 1:move (fragment)  2: move (chrom) 3:split block
    int selected_order;
    int selected_next_order = -1;//used for insert_order
    Map<Integer, List<Integer>> fragments_moved = new TreeMap<>();
